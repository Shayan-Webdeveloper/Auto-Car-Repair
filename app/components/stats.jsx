export default function StatsSection() {
  return (
    <section className="bg-[#232323] text-white mt-40">
      ...
      <div className="mx-auto grid max-w-6xl sm:grid-cols-2 grid-cols-1 gap-20 sm:gap-10 px-6 py-24 text-center md:grid-cols-4">
        <div>
          <h3 className="lg:text-6xl font-bold md:text-5xl text-2xl">20</h3>
          <p className="mt-4 text-lg text-gray-300">Years of Experience</p>
        </div>
        <div>
          <h3 className="lg:text-6xl font-bold md:text-5xl text-2xl">3.8</h3>
          <p className="mt-4 text-lg text-gray-300">Vehicle Repaired</p>
        </div>
        <div>
          <h3 className="lg:text-6xl font-bold md:text-5xl text-2xl">30</h3>
          <p className="mt-4 text-lg text-gray-300">Technicians and Workers</p>
        </div>
        <div>
          <h3 className="lg:text-6xl font-bold md:text-5xl text-2xl">100%</h3>
