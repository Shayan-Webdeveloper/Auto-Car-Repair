...
export default function Choose() {
     return(
     <div className="mt-25 ms-30">
          <h1 className="text-5xl text-white">
Why Choose Us?
          </h1>
          <p className="text-red-500 text-2xl mt-4">We're here for whatever you need</p>
          <div className="flex mt-15">
               <div className="rounded w-1/2 overflow-hidden">
                    <Image
                         src="/choosing.jfif"
                         alt="Auto Works"
                         width={400}
               ...
               <div className="flex w-1/2 flex-col gap-4 [&>div>div:first-child]:flex [&>div>div:first-child]:size-14 [&>div>div:first-child]:shrink-0 [&>div>div:first-child]:items-center [&>div>div:first-child]:justify-center">
                    <div className="flex items-center gap-6 px-10">
                         ...
                         <div>
                              ...
                              <p className="w-100 my-4 text-[#909090]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis architecto perferendis libero deleniti ullam ipsam error reiciendis consectetur ratione animi earum tem</p>
                         </div>
                    </div>
                    <div className="flex items-center gap-6 bg-[#292929] w-full px-10 py-4">
                         ...
                         <div>
                              <h2 className="text-white text-2xl font-medium ">Competetive Pricing</h2>
                              <p className="w-100 my-4 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis architecto perferendis libero deleniti ullam ipsam error reiciendis consectetur ratione animi earum tem</p>
                         </div>
                    </div>
                    <div className="flex items-center gap-6 px-10">
